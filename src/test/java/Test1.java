...
public class Test1
{
    ...
    public void testSetUp(String browser, String version, String platform, String resolution) throws Exception
    {
        ...
        capabilities.setCapability("build", "[HyperExecute Lambdatest BootCamp Challenge - 1]");
        capabilities.setCapability("name", "[HyperExecute Lambdatest BootCamp Challenge - 1]");
